...
functions (compose-inference-cluster, compose-kserve-backend) match on the type
string to find the right secret. Changing a type here without updating all
consumers would silently break the lookup.
"""

# Secret types written by compose-gke-cluster, read by compose-inference-cluster
