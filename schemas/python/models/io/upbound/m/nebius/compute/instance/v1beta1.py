...
#   filename:  workdir/compute_nebius_m_upbound_io_v1beta1_instance.yaml
...
class Instance(BaseModel):
    apiVersion: Literal['compute.nebius.m.upbound.io/v1beta1'] | None = (
        'compute.nebius.m.upbound.io/v1beta1'
    )
    """
