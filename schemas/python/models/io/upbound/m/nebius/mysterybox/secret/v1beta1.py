...
#   filename:  workdir/mysterybox_nebius_m_upbound_io_v1beta1_secret.yaml
...
class Status(BaseModel):
    ...
    """
    effectiveKmsKeyId: str | None = None
    """
    (String)
    """
...
class AtProvider(BaseModel):
    ...
    Identifier of the parent resource to which the resource belongs.
    """
    primaryVersionId: str | None = None
    """
    (String) Specifies the primary version of the secret to update its payload. This parameter should only be provided during update operations.
    ...
    """
    secretVersion: SecretVersion | None = None
    """
    (Attributes) :
    """
    status: Status | None = None
    """
    (Attributes) The status of the secret. (see below for nested schema)
    """
...
class SecretList(BaseModel):
    ...
    items: list[Secret]
    """
    List of secrets. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: str | None = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
