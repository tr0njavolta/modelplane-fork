...
#   filename:  workdir/mysterybox_nebius_m_upbound_io_v1beta1_secretversion.yaml
...
class BinaryValueSecretRef(BaseModel):
    key: str
    name: str
    """
    Name of the secret.
...
class StringValueSecretRef(BaseModel):
    key: str
    name: str
    """
    Name of the secret.
...
class PayloadItem(BaseModel):
    binaryValueSecretRef: BinaryValueSecretRef | None = None
    """
    (String, Sensitive) :
    :
    ...
    *Cannot be set alongside string_value.*
    ...
    """
    stringValueSecretRef: StringValueSecretRef | None = None
    """
    (String, Sensitive) :
    :
...
class PayloadItemModel(BaseModel):
    key: str | None = None
    """
    confidential key of the payload entry.
    Non-confidential key of the payload entry.
...
class AtProvider(BaseModel):
    ...
    Identifier of the parent resource to which the resource belongs.
    """
    payload: list[PayloadItemModel] | None = None
    """
    (Attributes List) :
    """
...
class SecretVersion(BaseModel):
    apiVersion: Literal['mysterybox.nebius.m.upbound.io/v1beta1'] | None = (
        'mysterybox.nebius.m.upbound.io/v1beta1'
    )
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    kind: Literal['SecretVersion'] | None = 'SecretVersion'
    """
...
class SecretVersionList(BaseModel):
    ...
    """
    List of secretversions. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: str | None = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
