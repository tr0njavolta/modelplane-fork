...
#   filename:  workdir/quotas_nebius_m_upbound_io_v1beta1_quotaallowance.yaml
...
class QuotaAllowance(BaseModel):
    apiVersion: Literal['quotas.nebius.m.upbound.io/v1beta1'] | None = (
        'quotas.nebius.m.upbound.io/v1beta1'
    )
    """
