...
#   filename:  workdir/iam_nebius_m_upbound_io_v1beta1_invitation.yaml
...
class EmailSecretRef(BaseModel):
    key: str
    name: str
    """
    Name of the secret.
...
class ForProvider(BaseModel):
    ...
    emailSecretRef: EmailSecretRef | None = None
    """
...
class Status(BaseModel):
    ...
    """
    tenantUserAccountId: str | None = None
...
class Invitation(BaseModel):
    ...
    """
    kind: Literal['Invitation'] | None = 'Invitation'
    """
...
class InvitationList(BaseModel):
    ...
    """
    List of invitations. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: str | None = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
