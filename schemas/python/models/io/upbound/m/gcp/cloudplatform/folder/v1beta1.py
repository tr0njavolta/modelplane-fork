...
#   filename:  workdir/cloudplatform_gcp_m_upbound_io_v1beta1_folder.yaml
...
class ParentSelector(BaseModel):
...
class ForProvider(BaseModel):
    ...
    """
    parentRef: ParentRef | None = None
    """
    Reference to a Folder in cloudplatform to populate parent.
    """
    parentSelector: ParentSelector | None = None
    """
...
class Folder(BaseModel):
    ...
    """
    kind: Literal['Folder'] | None = 'Folder'
    """
