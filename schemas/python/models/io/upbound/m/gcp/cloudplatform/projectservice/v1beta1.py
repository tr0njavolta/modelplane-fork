...
#   filename:  workdir/cloudplatform_gcp_m_upbound_io_v1beta1_projectservice.yaml
...
class ForProvider(BaseModel):
    disableDependentServices: Optional[bool] = None
    """
    ...
    """
    disableOnDestroy: Optional[bool] = None
    """
...
class ProjectService(BaseModel):
    ...
    """
    kind: Optional[Literal['ProjectService']] = 'ProjectService'
    """
...
class ProjectServiceList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[ProjectService]
    """
    List of projectservices. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
