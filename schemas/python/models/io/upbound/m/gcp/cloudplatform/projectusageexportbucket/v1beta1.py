...
#   filename:  workdir/cloudplatform_gcp_m_upbound_io_v1beta1_projectusageexportbucket.yaml
...
class ProjectUsageExportBucket(BaseModel):
    ...
    """
    kind: Optional[Literal['ProjectUsageExportBucket']] = 'ProjectUsageExportBucket'
    """
...
class ProjectUsageExportBucketList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[ProjectUsageExportBucket]
    """
    List of projectusageexportbuckets. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
