...
class RayOperatorConfigItem(BaseModel):
    ...
    Enables vertical pod autoscaling
    """
    rayClusterLoggingConfig: RayClusterLoggingConfig | None = None
    """
    Logging configuration for the cluster.
    Structure is documented below.
    """
    rayClusterMonitoringConfig: RayClusterMonitoringConfig | None = None
    """
...
class AddonsConfig(BaseModel):
    cloudrunConfig: CloudrunConfig | None = None
    """
    . Structure is documented below.
    """
    configConnectorConfig: ConfigConnectorConfig | None = None
    """
    .
    The status of the ConfigConnector addon. It is disabled by default; Set enabled = true to enable.
    """
    dnsCacheConfig: DnsCacheConfig | None = None
    """
    .
    The status of the NodeLocal DNSCache addon. It is disabled by default.
    Set enabled = true to enable.
    """
    gcePersistentDiskCsiDriverConfig: GcePersistentDiskCsiDriverConfig | None = None
    """
    .
    ...
    """
    gcpFilestoreCsiDriverConfig: GcpFilestoreCsiDriverConfig | None = None
    """
    The status of the Filestore CSI driver addon,
    which allows the usage of filestore instance as volumes.
    It is disabled by default; set enabled = true to enable.
    """
    gcsFuseCsiDriverConfig: GcsFuseCsiDriverConfig | None = None
    """
    ...
    """
    gkeBackupAgentConfig: GkeBackupAgentConfig | None = None
    """
    .
    The status of the Backup for GKE agent addon. It is disabled by default; Set enabled = true to enable.
    """
    horizontalPodAutoscaling: HorizontalPodAutoscaling | None = None
    """
    ...
    """
    httpLoadBalancing: HttpLoadBalancing | None = None
    """
    The status of the HTTP (L7) load balancing
    controller addon, which makes it easy to set up HTTP load balancers for services in a
    cluster. It is enabled by default; set disabled = true to disable.
    """
    lustreCsiDriverConfig: LustreCsiDriverConfig | None = None
    """
    ...
    """
    networkPolicyConfig: NetworkPolicyConfig | None = None
    """
    ...
    """
    parallelstoreCsiDriverConfig: ParallelstoreCsiDriverConfig | None = None
    """
    ...
    """
    statefulHaConfig: StatefulHaConfig | None = None
    """
    .
...
class ClusterAutoscaling(BaseModel):
    autoProvisioningDefaults: AutoProvisioningDefaults | None = None
    """
...
class ControlPlaneEndpointsConfig(BaseModel):
    dnsEndpointConfig: DnsEndpointConfig | None = None
    """
    DNS endpoint configuration.
    """
    ipEndpointsConfig: IpEndpointsConfig | None = None
    """
...
class IpAllocationPolicy(BaseModel):
    ...
    Structure is documented below.
    """
    additionalPodRangesConfig: AdditionalPodRangesConfig | None = None
    """
...
class MaintenanceExclusionItem(BaseModel):
    ...
    location.
    """
    exclusionOptions: ExclusionOptions | None = None
    """
...
class MaintenancePolicy(BaseModel):
    dailyMaintenanceWindow: DailyMaintenanceWindow | None = None
    """
    ...
    structure documented below
    """
    recurringWindow: RecurringWindow | None = None
    """
    structure documented below
    """
...
class MasterAuth(BaseModel):
    clientCertificateConfig: ClientCertificateConfig | None = None
    """
...
class ManagedPrometheus(BaseModel):
    autoMonitoringConfig: AutoMonitoringConfig | None = None
    """
...
class MonitoringConfig(BaseModel):
    advancedDatapathObservabilityConfig: AdvancedDatapathObservabilityConfig | None = (
        None
    )
    """
    ...
    """
    managedPrometheus: ManagedPrometheus | None = None
    """
...
class NodeConfig(BaseModel):
    ...
    The Customer Managed Encryption Key used to encrypt the boot disk attached to each node in the node pool. This should be of the form projects/[KEY_PROJECT_ID]/locations/[LOCATION]/keyRings/[RING_NAME]/cryptoKeys/[KEY_NAME]. For more information about protecting resources with Cloud KMS Keys please see: https://cloud.google.com/compute/docs/disks/customer-managed-encryption
    """
    confidentialNodes: ConfidentialNodesModel | None = None
    """
...
class NodePoolAutoConfig(BaseModel):
    linuxNodeConfig: LinuxNodeConfigModel | None = None
    """
...
class NodePoolDefaults(BaseModel):
    nodeConfigDefaults: NodeConfigDefaults | None = None
    """
...
class PrivateClusterConfig(BaseModel):
    ...
    """
    masterGlobalAccessConfig: MasterGlobalAccessConfig | None = None
    """
...
class ResourceUsageExportConfig(BaseModel):
    bigqueryDestination: BigqueryDestination | None = None
    """
...
class ForProvider(BaseModel):
    addonsConfig: AddonsConfig | None = None
    """
    ...
    set to true).
    """
    anonymousAuthenticationConfig: AnonymousAuthenticationConfig | None = None
    """
    Configuration for anonymous authentication restrictions. Structure is documented below.
    """
    authenticatorGroupsConfig: AuthenticatorGroupsConfig | None = None
    """
    Configuration for the
    Google Groups for GKE feature.
    Structure is documented below.
    """
    binaryAuthorization: BinaryAuthorization | None = None
    """
    Configuration options for the Binary
    Authorization feature. Structure is documented below.
    """
    clusterAutoscaling: ClusterAutoscaling | None = None
    """
    ...
    """
    controlPlaneEndpointsConfig: ControlPlaneEndpointsConfig | None = None
    """
    Configuration for all of the cluster's control plane endpoints.
    Structure is documented below.
    """
    costManagementConfig: CostManagementConfig | None = None
    """
    Configuration for the
    Cost Allocation feature.
    Structure is documented below.
    """
    databaseEncryption: DatabaseEncryption | None = None
    """
    Structure is documented below.
    """
    ...
    for more information.
    """
    defaultSnatStatus: DefaultSnatStatus | None = None
    """
    ...
    """
    enableK8SBetaApis: EnableK8SBetaApis | None = None
    """
    ...
    See the official documentation.
    """
    enterpriseConfig: EnterpriseConfig | None = None
    """
    ...
    """
    gatewayApiConfig: GatewayApiConfig | None = None
    """
    Configuration for GKE Gateway API controller. Structure is documented below.
    """
    gkeAutoUpgradeConfig: GkeAutoUpgradeConfig | None = None
    """
    ...
    Structure is documented below.
    """
    identityServiceConfig: IdentityServiceConfig | None = None
    """
    . Structure is documented below.
    """
    ...
    """
    ipAllocationPolicy: IpAllocationPolicy | None = None
    """
    ...
    """
    maintenancePolicy: MaintenancePolicy | None = None
    """
    The maintenance policy to use for the cluster. Structure is
    documented below.
    """
    masterAuth: MasterAuth | None = None
    """
    ...
    Structure is documented below.
    """
    masterAuthorizedNetworksConfig: MasterAuthorizedNetworksConfig | None = None
    """
    The desired
    ...
    Structure is documented below.
    """
    meshCertificates: MeshCertificates | None = None
    """
    Structure is documented below.
    """
    ...
    """
    monitoringConfig: MonitoringConfig | None = None
    """
    Monitoring configuration for the cluster.
    Structure is documented below.
    """
    ...
    """
    nodePoolAutoConfig: NodePoolAutoConfig | None = None
    """
    ...
    """
    nodePoolDefaults: NodePoolDefaults | None = None
    """
    ...
    """
    notificationConfig: NotificationConfig | None = None
    """
    Configuration for the cluster upgrade notifications feature. Structure is documented below.
    """
    podAutoscaling: PodAutoscaling | None = None
    """
    Configuration for the
    Structure is documented below.
    """
    privateClusterConfig: PrivateClusterConfig | None = None
    """
    ...
    """
    rbacBindingConfig: RbacBindingConfig | None = None
    """
    ...
    """
    releaseChannel: ReleaseChannel | None = None
    """
    ...
    """
    resourceUsageExportConfig: ResourceUsageExportConfig | None = None
    """
    Configuration for the
    ResourceUsageExportConfig feature.
    Structure is documented below.
    """
    secretManagerConfig: SecretManagerConfig | None = None
    """
    Configuration for the
    SecretManagerConfig feature.
    Structure is documented below.
    """
    securityPostureConfig: SecurityPostureConfig | None = None
    """
    Enable/Disable Security Posture API features for the cluster. Structure is documented below.
    """
    serviceExternalIpsConfig: ServiceExternalIpsConfig | None = None
    """
    Structure is documented below.
    """
    subnetwork: str | None = None
    ...
    """
    userManagedKeysConfig: UserManagedKeysConfig | None = None
    """
    The custom keys configuration of the cluster Structure is documented below.
    """
    verticalPodAutoscaling: VerticalPodAutoscaling | None = None
    """
    Vertical Pod Autoscaling automatically adjusts the resources of pods controlled by it.
    Structure is documented below.
    """
    workloadIdentityConfig: WorkloadIdentityConfig | None = None
    """
...
class InitProvider(BaseModel):
    ...
    default a new cluster to routes-based, where ip_allocation_policy is not defined.
    """
    confidentialNodes: ConfidentialNodesModel1 | None = None
    """
    Configuration for Confidential Nodes feature. Structure is documented below documented below.
    """
    controlPlaneEndpointsConfig: ControlPlaneEndpointsConfig | None = None
...
class NodeConfigModel(BaseModel):
    ...
    The Customer Managed Encryption Key used to encrypt the boot disk attached to each node in the node pool. This should be of the form projects/[KEY_PROJECT_ID]/locations/[LOCATION]/keyRings/[RING_NAME]/cryptoKeys/[KEY_NAME]. For more information about protecting resources with Cloud KMS Keys please see: https://cloud.google.com/compute/docs/disks/customer-managed-encryption
    """
    confidentialNodes: ConfidentialNodesModel4 | None = None
    """
    Configuration for Confidential Nodes feature. Structure is documented below.
    """
    containerdConfig: ContainerdConfig | None = None
    ...
    reserved by Kubernetes Core components and cannot be specified.
    """
    linuxNodeConfig: LinuxNodeConfigModel3 | None = None
    """
    Parameters that can be configured on Linux nodes. Structure is documented below.
    """
    localNvmeSsdBlockConfig: LocalNvmeSsdBlockConfig | None = None
...
class NodePoolItem(BaseModel):
    ...
    management: ManagementModel1 | None = None
    """
    NodeManagement configuration for this NodePool. Structure is documented below.
    """
    maxPodsPerNode: float | None = None
    ...
    nodeConfig: NodeConfigModel1 | None = None
    """
    Parameters used in creating the default node pool. Structure is documented below.
    """
...
class AtProvider(BaseModel):
    ...
    default a new cluster to routes-based, where ip_allocation_policy is not defined.
    """
    confidentialNodes: ConfidentialNodesModel3 | None = None
    """
    Configuration for Confidential Nodes feature. Structure is documented below documented below.
    """
    controlPlaneEndpointsConfig: ControlPlaneEndpointsConfig | None = None
    ...
    """
    enterpriseConfig: EnterpriseConfigModel | None = None
    """
    Configuration for [Enterprise edition].(https://cloud.google.com/kubernetes-engine/enterprise/docs/concepts/gke-editions). Structure is documented below.
    """
    ...
    documented below.
    """
    masterAuth: MasterAuthModel | None = None
    """
    The authentication information for accessing the
    Kubernetes master. Some values in this block are only returned by the API if
    your service account has permission to get credentials for your GKE cluster. If
    ...
    Structure is documented below.
    """
    privateClusterConfig: PrivateClusterConfigModel | None = None
    """
    Configuration for private clusters,
    clusters with private nodes. Structure is documented below.
    """
...
class Cluster(BaseModel):
    apiVersion: Literal['container.gcp.m.upbound.io/v1beta1'] | None = (
