...
#   filename:  workdir/compute_gcp_m_upbound_io_v1beta1_regionsslcertificate.yaml
...
class CertificateSecretRef(BaseModel):
    key: str
    name: str
    """
    Name of the secret.
...
class ForProvider(BaseModel):
    certificateSecretRef: Optional[CertificateSecretRef] = None
    """
...
class RegionSSLCertificate(BaseModel):
    ...
    """
    kind: Optional[Literal['RegionSSLCertificate']] = 'RegionSSLCertificate'
    """
...
class RegionSSLCertificateList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[RegionSSLCertificate]
    """
    List of regionsslcertificates. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
