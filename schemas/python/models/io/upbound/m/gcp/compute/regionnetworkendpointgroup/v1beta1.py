...
#   filename:  workdir/compute_gcp_m_upbound_io_v1beta1_regionnetworkendpointgroup.yaml
...
class ForProvider(BaseModel):
    appEngine: Optional[AppEngine] = None
    """
    ...
    Structure is documented below.
    """
    cloudRun: Optional[CloudRun] = None
    """
    This field is only used for SERVERLESS NEGs.
    Only one of cloud_run, app_engine, cloud_function or serverless_deployment may be set.
    Structure is documented below.
...
class AtProvider(BaseModel):
    ...
    Structure is documented below.
    """
    cloudFunction: Optional[CloudFunctionModel] = None
    """
    This field is only used for SERVERLESS NEGs.
    Only one of cloud_run, app_engine, cloud_function or serverless_deployment may be set.
    Structure is documented below.
    """
    cloudRun: Optional[CloudRunModel] = None
    """
    This field is only used for SERVERLESS NEGs.
    Only one of cloud_run, app_engine, cloud_function or serverless_deployment may be set.
    Structure is documented below.
