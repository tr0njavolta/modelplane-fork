...
#   filename:  workdir/compute_gcp_m_upbound_io_v1beta1_httphealthcheck.yaml
...
class HTTPHealthCheck(BaseModel):
    ...
    """
    kind: Optional[Literal['HTTPHealthCheck']] = 'HTTPHealthCheck'
    """
...
class HTTPHealthCheckList(BaseModel):
    ...
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[HTTPHealthCheck]
    """
    List of httphealthchecks. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
