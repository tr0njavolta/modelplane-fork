...
#   filename:  workdir/compute_gcp_m_upbound_io_v1beta1_regionnetworkfirewallpolicy.yaml
...
class AtProvider(BaseModel):
    ...
    The region of this resource.
    """
    regionNetworkFirewallPolicyId: Optional[str] = None
    """
...
class RegionNetworkFirewallPolicy(BaseModel):
    ...
    """
    kind: Optional[Literal['RegionNetworkFirewallPolicy']] = (
...
class RegionNetworkFirewallPolicyList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[RegionNetworkFirewallPolicy]
    """
    List of regionnetworkfirewallpolicies. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
