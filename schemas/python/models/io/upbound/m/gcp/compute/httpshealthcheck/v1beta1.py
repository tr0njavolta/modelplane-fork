...
#   filename:  workdir/compute_gcp_m_upbound_io_v1beta1_httpshealthcheck.yaml
...
class HTTPSHealthCheck(BaseModel):
    ...
    """
    kind: Optional[Literal['HTTPSHealthCheck']] = 'HTTPSHealthCheck'
    """
...
class HTTPSHealthCheckList(BaseModel):
    ...
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[HTTPSHealthCheck]
    """
    List of httpshealthchecks. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
