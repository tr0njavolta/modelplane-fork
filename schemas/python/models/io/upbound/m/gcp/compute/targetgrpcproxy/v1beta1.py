...
#   filename:  workdir/compute_gcp_m_upbound_io_v1beta1_targetgrpcproxy.yaml
...
class ForProvider(BaseModel):
    ...
    """
    validateForProxyless: Optional[bool] = None
    """
...
class TargetGRPCProxy(BaseModel):
    ...
    """
    kind: Optional[Literal['TargetGRPCProxy']] = 'TargetGRPCProxy'
    """
...
class TargetGRPCProxyList(BaseModel):
    ...
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[TargetGRPCProxy]
    """
    List of targetgrpcproxies. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
