...
#   filename:  workdir/compute_gcp_m_upbound_io_v1beta1_sslcertificate.yaml
...
class SSLCertificate(BaseModel):
    ...
    """
    kind: Optional[Literal['SSLCertificate']] = 'SSLCertificate'
    """
...
class SSLCertificateList(BaseModel):
    ...
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[SSLCertificate]
    """
    List of sslcertificates. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
