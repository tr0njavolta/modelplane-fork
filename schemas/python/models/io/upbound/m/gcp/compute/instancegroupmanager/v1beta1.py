...
class VersionItem(BaseModel):
    ...
    - Version name.
    """
    targetSize: Optional[TargetSize] = None
    """
...
class ForProvider(BaseModel):
    allInstancesConfig: Optional[AllInstancesConfig] = None
    """
    Properties to set on all instances in the group. After setting
    allInstancesConfig on the group, you must update the group's instances to
    apply the configuration.
    """
    autoHealingPolicies: Optional[AutoHealingPolicies] = None
    """
    ...
    group manager.
    """
    instanceLifecyclePolicy: Optional[InstanceLifecyclePolicy] = None
    ...
    """
    standbyPolicy: Optional[StandbyPolicy] = None
    """
...
class AtProvider(BaseModel):
    ...
    apply the configuration.
    """
    autoHealingPolicies: Optional[AutoHealingPoliciesModel] = None
    """
    The autohealing policies for this managed instance
    group. You can specify only one value. Structure is documented below. For more information, see the official documentation.
    """
    ...
    is not provided, the provider project is used.
    """
    resourcePolicies: Optional[ResourcePoliciesModel] = None
    """
    Resource policies for this managed instance group. Structure is documented below.
    """
...
class InstanceGroupManager(BaseModel):
    ...
    """
    kind: Optional[Literal['InstanceGroupManager']] = 'InstanceGroupManager'
    """
