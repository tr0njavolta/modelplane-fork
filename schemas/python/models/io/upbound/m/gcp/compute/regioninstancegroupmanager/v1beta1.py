...
#   filename:  workdir/compute_gcp_m_upbound_io_v1beta1_regioninstancegroupmanager.yaml
...
class InstanceFlexibilityPolicy(BaseModel):
...
class ForProvider(BaseModel):
    ...
    """
    instanceFlexibilityPolicy: InstanceFlexibilityPolicy | None = None
    """
