...
#   filename:  workdir/compute_gcp_m_upbound_io_v1beta1_imageiammember.yaml
...
class ImageIAMMember(BaseModel):
    ...
    """
    kind: Optional[Literal['ImageIAMMember']] = 'ImageIAMMember'
    """
...
class ImageIAMMemberList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[ImageIAMMember]
    """
    List of imageiammembers. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
