...
#   filename:  workdir/compute_gcp_m_upbound_io_v1beta1_targetinstance.yaml
...
class TargetInstance(BaseModel):
    ...
    """
    kind: Optional[Literal['TargetInstance']] = 'TargetInstance'
    """
...
class TargetInstanceList(BaseModel):
    ...
    """
    List of targetinstances. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
