...
class ForProvider(BaseModel):
    attachmentTarget: Optional[str] = None
    """
    The target that the firewall policy is attached to.
    """
    attachmentTargetRef: Optional[AttachmentTargetRef] = None
    """
    Reference to a Network in compute to populate attachmentTarget.
    """
    attachmentTargetSelector: Optional[AttachmentTargetSelector] = None
    """
...
class RegionNetworkFirewallPolicyAssociation(BaseModel):
    ...
    """
    kind: Optional[Literal['RegionNetworkFirewallPolicyAssociation']] = (
