...
#   filename:  workdir/compute_gcp_m_upbound_io_v1beta1_instanceiammember.yaml
...
class InstanceNameRef(BaseModel):
    name: str
    """
...
class InstanceNameSelector(BaseModel):
...
class ForProvider(BaseModel):
    ...
    instanceNameRef: Optional[InstanceNameRef] = None
    """
    Reference to a Instance in compute to populate instanceName.
    """
    instanceNameSelector: Optional[InstanceNameSelector] = None
    """
...
class InstanceIAMMember(BaseModel):
    ...
    """
    kind: Optional[Literal['InstanceIAMMember']] = 'InstanceIAMMember'
    """
...
class InstanceIAMMemberList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[InstanceIAMMember]
    """
    List of instanceiammembers. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
