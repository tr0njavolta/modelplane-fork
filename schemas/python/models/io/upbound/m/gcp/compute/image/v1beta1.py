...
#   filename:  workdir/compute_gcp_m_upbound_io_v1beta1_image.yaml
...
class ShieldedInstanceInitialState(BaseModel):
...
class ForProvider(BaseModel):
    ...
    Structure is documented below.
    """
    imageEncryptionKey: Optional[ImageEncryptionKey] = None
    """
    ...
    """
    rawDisk: Optional[RawDisk] = None
    """
    The parameters of the raw disk image.
    Structure is documented below.
    """
    shieldedInstanceInitialState: Optional[ShieldedInstanceInitialState] = None
    """
...
class ImageEncryptionKeyModel(BaseModel):
    kmsKeySelfLink: Optional[str] = None
    """
    The self link of the encryption key that is stored in Google Cloud
    KMS.
...
class AtProvider(BaseModel):
    ...
    """
    imageEncryptionKey: Optional[ImageEncryptionKeyModel] = None
    """
    Encrypts the image using a customer-supplied encryption key.
    After you encrypt an image with a customer-supplied key, you must
    provide the same key if you use the image later (e.g. to create a
