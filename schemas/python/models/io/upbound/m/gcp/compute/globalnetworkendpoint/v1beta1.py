...
#   filename:  workdir/compute_gcp_m_upbound_io_v1beta1_globalnetworkendpoint.yaml
...
class GlobalNetworkEndpointGroupRef(BaseModel):
    name: str
    """
...
class GlobalNetworkEndpointGroupSelector(BaseModel):
...
class ForProvider(BaseModel):
    ...
    """
    globalNetworkEndpointGroup: Optional[str] = None
    """
    The global network endpoint group this endpoint is part of.
    """
    globalNetworkEndpointGroupRef: Optional[GlobalNetworkEndpointGroupRef] = None
    """
    Reference to a GlobalNetworkEndpointGroup in compute to populate globalNetworkEndpointGroup.
    """
    globalNetworkEndpointGroupSelector: Optional[GlobalNetworkEndpointGroupSelector] = (
        None
    )
    """
...
class GlobalNetworkEndpoint(BaseModel):
    ...
    """
    kind: Optional[Literal['GlobalNetworkEndpoint']] = 'GlobalNetworkEndpoint'
    """
...
class GlobalNetworkEndpointList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[GlobalNetworkEndpoint]
    """
    List of globalnetworkendpoints. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
