...
#   filename:  workdir/compute_gcp_m_upbound_io_v1beta1_sharedvpcserviceproject.yaml
...
class HostProjectRef(BaseModel):
    name: str
    """
...
class HostProjectSelector(BaseModel):
...
class ServiceProjectRef(BaseModel):
    name: str
    """
    Name of the referenced object.
    """
...
class ServiceProjectSelector(BaseModel):
    matchControllerRef: bool | None = None
    """
    MatchControllerRef ensures an object with the same controller reference
    as the selecting object is selected.
...
class ForProvider(BaseModel):
    ...
    """
    hostProject: str | None = None
    """
    The ID of a host project to associate.
    """
    hostProjectRef: HostProjectRef | None = None
    """
    Reference to a Project in cloudplatform to populate hostProject.
    """
    hostProjectSelector: HostProjectSelector | None = None
    """
    Selector for a Project in cloudplatform to populate hostProject.
    """
    serviceProject: str | None = None
    """
    The ID of the project that will serve as a Shared VPC service project.
    """
    serviceProjectRef: ServiceProjectRef | None = None
    """
    Reference to a Project in cloudplatform to populate serviceProject.
    """
    serviceProjectSelector: ServiceProjectSelector | None = None
    """
...
class SharedVPCServiceProject(BaseModel):
    ...
    """
    kind: Literal['SharedVPCServiceProject'] | None = 'SharedVPCServiceProject'
    """
...
class SharedVPCServiceProjectList(BaseModel):
    apiVersion: str | None = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: list[SharedVPCServiceProject]
    """
    List of sharedvpcserviceprojects. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: str | None = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
