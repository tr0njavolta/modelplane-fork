...
#   filename:  workdir/containerservice_azure_m_upbound_io_v1beta1_kubernetesfleetmanager.yaml
...
class ForProvider(BaseModel):
    hubProfile: HubProfile | None = None
...
class HubProfileModel(BaseModel):
    dnsPrefix: str | None = None
    fqdn: str | None = None
...
class AtProvider(BaseModel):
    hubProfile: HubProfileModel | None = None
    id: str | None = None
    """
