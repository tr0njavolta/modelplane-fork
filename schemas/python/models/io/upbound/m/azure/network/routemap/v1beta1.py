...
#   filename:  workdir/network_azure_m_upbound_io_v1beta1_routemap.yaml
...
class ParameterItem(BaseModel):
    ...
    """
    routePrefix: list[str] | None = None
    """
...
class ActionItem(BaseModel):
    parameter: list[ParameterItem] | None = None
    """
...
class MatchCriterionItem(BaseModel):
    asPath: list[str] | None = None
    """
    A list of AS paths.
    """
...
class RuleItem(BaseModel):
    ...
    """
    matchCriterion: list[MatchCriterionItem] | None = None
    """
    ...
    """
    nextStepIfMatched: str | None = None
    """
...
class RouteMap(BaseModel):
    ...
    """
    kind: Literal['RouteMap'] | None = 'RouteMap'
    """
...
class RouteMapList(BaseModel):
    ...
    items: list[RouteMap]
    """
    List of routemaps. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: str | None = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
