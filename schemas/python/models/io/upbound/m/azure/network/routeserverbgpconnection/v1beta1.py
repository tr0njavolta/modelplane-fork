...
#   filename:  workdir/network_azure_m_upbound_io_v1beta1_routeserverbgpconnection.yaml
...
class RouteServerIdRef(BaseModel):
    name: str
    """
...
class RouteServerIdSelector(BaseModel):
...
class ForProvider(BaseModel):
    ...
    """
    routeServerIdRef: RouteServerIdRef | None = None
    """
    Reference to a RouteServer in network to populate routeServerId.
    """
    routeServerIdSelector: RouteServerIdSelector | None = None
    """
...
class RouteServerBGPConnection(BaseModel):
    ...
    """
    kind: Literal['RouteServerBGPConnection'] | None = 'RouteServerBGPConnection'
    """
...
class RouteServerBGPConnectionList(BaseModel):
    apiVersion: str | None = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: list[RouteServerBGPConnection]
    """
    List of routeserverbgpconnections. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: str | None = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
