...
#   filename:  workdir/network_azure_m_upbound_io_v1beta1_watcher.yaml
...
class Watcher(BaseModel):
    ...
    """
    kind: Literal['Watcher'] | None = 'Watcher'
    """
...
class WatcherList(BaseModel):
    ...
    items: list[Watcher]
    """
    List of watchers. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: str | None = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
