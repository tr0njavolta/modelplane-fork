...
#   filename:  workdir/network_azure_m_upbound_io_v1beta1_ipgroup.yaml
...
class AtProvider(BaseModel):
    ...
    A list of CIDRs or IP addresses.
    """
    firewallIds: list[str] | None = None
    """
    A list of ID of Firewall.
    """
    firewallPolicyIds: list[str] | None = None
    """
...
class IPGroup(BaseModel):
    ...
    """
    kind: Literal['IPGroup'] | None = 'IPGroup'
    """
...
class IPGroupList(BaseModel):
    ...
    items: list[IPGroup]
    """
    List of ipgroups. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: str | None = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
