...
#   filename:  workdir/network_azure_m_upbound_io_v1beta1_privatednsresolverinboundendpoint.yaml
...
class IpConfigurations(BaseModel):
    ...
    """
    privateIpAllocationMethod: str | None = None
    """
...
class PrivateDnsResolverIdRef(BaseModel):
    name: str
    """
    Name of the referenced object.
    """
...
class PrivateDnsResolverIdSelector(BaseModel):
    matchControllerRef: bool | None = None
    """
    MatchControllerRef ensures an object with the same controller reference
    as the selecting object is selected.
...
class ForProvider(BaseModel):
    ...
    """
    privateDnsResolverId: str | None = None
    """
    ...
    """
    privateDnsResolverIdRef: PrivateDnsResolverIdRef | None = None
    """
    Reference to a PrivateDNSResolver in network to populate privateDnsResolverId.
    """
    privateDnsResolverIdSelector: PrivateDnsResolverIdSelector | None = None
    """
...
class IpConfigurationsModel(BaseModel):
    privateIpAddress: str | None = None
    """
    Private IP address of the IP configuration.
    """
...
class AtProvider(BaseModel):
    ...
    """
    ipConfigurations: IpConfigurationsModel | None = None
    """
    One ip_configurations block as defined below. Changing this forces a new Private DNS Resolver Inbound Endpoint to be created.
    """
    location: str | None = None
...
class PrivateDNSResolverInboundEndpoint(BaseModel):
    ...
    """
    kind: Literal['PrivateDNSResolverInboundEndpoint'] | None = (
...
class PrivateDNSResolverInboundEndpointList(BaseModel):
    apiVersion: str | None = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: list[PrivateDNSResolverInboundEndpoint]
    """
    List of privatednsresolverinboundendpoints. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: str | None = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
