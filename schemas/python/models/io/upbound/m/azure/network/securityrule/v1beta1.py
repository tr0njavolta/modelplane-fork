...
#   filename:  workdir/network_azure_m_upbound_io_v1beta1_securityrule.yaml
...
class NetworkSecurityGroupNameRef(BaseModel):
    name: str
    """
...
class NetworkSecurityGroupNameSelector(BaseModel):
...
class ForProvider(BaseModel):
    ...
    """
    networkSecurityGroupName: str | None = None
    """
    The name of the Network Security Group that we want to attach the rule to. Changing this forces a new resource to be created.
    """
    networkSecurityGroupNameRef: NetworkSecurityGroupNameRef | None = None
    """
    Reference to a SecurityGroup in network to populate networkSecurityGroupName.
    """
    networkSecurityGroupNameSelector: NetworkSecurityGroupNameSelector | None = None
    """
