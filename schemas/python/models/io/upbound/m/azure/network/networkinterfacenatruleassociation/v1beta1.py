...
#   filename:  workdir/network_azure_m_upbound_io_v1beta1_networkinterfacenatruleassociation.yaml
...
class NatRuleIdSelector(BaseModel):
...
class ForProvider(BaseModel):
    ...
    """
    natRuleId: str | None = None
    """
    The ID of the Load Balancer NAT Rule which this Network Interface which should be connected to. Changing this forces a new resource to be created.
    """
    natRuleIdRef: NatRuleIdRef | None = None
    """
    Reference to a LoadBalancerNatRule in network to populate natRuleId.
    """
    natRuleIdSelector: NatRuleIdSelector | None = None
    """
...
class NetworkInterfaceNatRuleAssociation(BaseModel):
    ...
    """
    kind: Literal['NetworkInterfaceNatRuleAssociation'] | None = (
...
class NetworkInterfaceNatRuleAssociationList(BaseModel):
    apiVersion: str | None = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: list[NetworkInterfaceNatRuleAssociation]
    """
    List of networkinterfacenatruleassociations. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: str | None = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
