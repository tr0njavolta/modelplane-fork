...
#   filename:  workdir/iam_aws_m_upbound_io_v1beta1_virtualmfadevice.yaml
...
class ForProvider(BaseModel):
    ...
    """
    virtualMfaDeviceName: Optional[str] = None
    """
...
class VirtualMfaDevice(BaseModel):
    ...
    """
    kind: Optional[Literal['VirtualMfaDevice']] = 'VirtualMfaDevice'
    """
...
class VirtualMfaDeviceList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[VirtualMfaDevice]
    """
    List of virtualmfadevices. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
