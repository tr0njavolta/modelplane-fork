...
#   filename:  workdir/iam_aws_m_upbound_io_v1beta1_usergroupmembership.yaml
...
class ForProvider(BaseModel):
    groupRefs: Optional[List[GroupRef]] = None
    """
...
class UserGroupMembership(BaseModel):
    ...
    """
    kind: Optional[Literal['UserGroupMembership']] = 'UserGroupMembership'
    """
