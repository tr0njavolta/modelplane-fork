...
#   filename:  workdir/eks_aws_m_upbound_io_v1beta1_identityproviderconfig.yaml
...
class Oidc(BaseModel):
    ...
    """
    requiredClaims: dict[str, str] | None = None
    """
...
class IdentityProviderConfig(BaseModel):
    ...
    """
    kind: Literal['IdentityProviderConfig'] | None = 'IdentityProviderConfig'
    """
