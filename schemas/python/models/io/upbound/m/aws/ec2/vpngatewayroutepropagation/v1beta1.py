...
#   filename:  workdir/ec2_aws_m_upbound_io_v1beta1_vpngatewayroutepropagation.yaml
...
class VPNGatewayRoutePropagation(BaseModel):
    ...
    """
    kind: Optional[Literal['VPNGatewayRoutePropagation']] = 'VPNGatewayRoutePropagation'
    """
