...
#   filename:  workdir/ec2_aws_m_upbound_io_v1beta1_transitgatewaymulticastdomain.yaml
...
class ForProvider(BaseModel):
    autoAcceptSharedAssociations: str | None = None
    """
    ...
    """
    staticSourcesSupport: str | None = None
    """
...
class TransitGatewayMulticastDomain(BaseModel):
    ...
    """
    kind: Literal['TransitGatewayMulticastDomain'] | None = (
