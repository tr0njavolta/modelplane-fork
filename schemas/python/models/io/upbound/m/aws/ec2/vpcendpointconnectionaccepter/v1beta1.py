...
#   filename:  workdir/ec2_aws_m_upbound_io_v1beta1_vpcendpointconnectionaccepter.yaml
...
class ForProvider(BaseModel):
    ...
    """
    vpcEndpointServiceId: str | None = None
    """
    AWS VPC Endpoint Service ID.
    """
    vpcEndpointServiceIdRef: VpcEndpointServiceIdRef | None = None
    """
    Reference to a VPCEndpointService in ec2 to populate vpcEndpointServiceId.
    """
    vpcEndpointServiceIdSelector: VpcEndpointServiceIdSelector | None = None
    """
...
class AtProvider(BaseModel):
    ...
    AWS VPC Endpoint Service ID.
    """
    vpcEndpointState: str | None = None
    """
...
class VPCEndpointConnectionAccepter(BaseModel):
    ...
    """
    kind: Literal['VPCEndpointConnectionAccepter'] | None = (
...
class VPCEndpointConnectionAccepterList(BaseModel):
    apiVersion: str | None = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: list[VPCEndpointConnectionAccepter]
    """
    List of vpcendpointconnectionaccepters. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: str | None = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
