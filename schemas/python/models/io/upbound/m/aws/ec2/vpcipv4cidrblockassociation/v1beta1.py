...
#   filename:  workdir/ec2_aws_m_upbound_io_v1beta1_vpcipv4cidrblockassociation.yaml
...
class VPCIPv4CidrBlockAssociation(BaseModel):
    ...
    """
    kind: Literal['VPCIPv4CidrBlockAssociation'] | None = 'VPCIPv4CidrBlockAssociation'
    """
