...
#   filename:  workdir/ec2_aws_m_upbound_io_v1beta1_networkinterfaceattachment.yaml
...
class NetworkInterfaceAttachment(BaseModel):
    ...
    """
    kind: Optional[Literal['NetworkInterfaceAttachment']] = 'NetworkInterfaceAttachment'
    """
