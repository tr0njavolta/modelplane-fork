...
#   filename:  workdir/ec2_aws_m_upbound_io_v1beta1_defaultvpcdhcpoptions.yaml
...
class AtProvider(BaseModel):
    ...
    domainNameServers: str | None = None
    id: str | None = None
    """
    The ID of the DHCP Options Set.
    """
    ipv6AddressPreferredLeaseTime: str | None = None
    netbiosNameServers: str | None = None
    """
...
class DefaultVPCDHCPOptions(BaseModel):
    ...
    """
    kind: Literal['DefaultVPCDHCPOptions'] | None = 'DefaultVPCDHCPOptions'
    """
