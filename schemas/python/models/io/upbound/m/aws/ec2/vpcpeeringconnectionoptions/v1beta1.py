...
#   filename:  workdir/ec2_aws_m_upbound_io_v1beta1_vpcpeeringconnectionoptions.yaml
...
class VPCPeeringConnectionOptions(BaseModel):
    ...
    """
    kind: Literal['VPCPeeringConnectionOptions'] | None = 'VPCPeeringConnectionOptions'
    """
