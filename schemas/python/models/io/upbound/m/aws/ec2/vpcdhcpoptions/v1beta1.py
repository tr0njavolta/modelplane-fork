...
class ForProvider(BaseModel):
    ...
    """
    domainNameServers: list[str] | None = None
    """
    List of name servers to configure in /etc/resolv.conf. If you want to use the default AWS nameservers you should set this to AmazonProvidedDNS.
    """
    ipv6AddressPreferredLeaseTime: str | None = None
    """
    ...
    """
    netbiosNameServers: list[str] | None = None
    """
    List of NETBIOS name servers.
    """
    netbiosNodeType: str | None = None
    """
...
class VPCDHCPOptions(BaseModel):
    ...
    """
    kind: Literal['VPCDHCPOptions'] | None = 'VPCDHCPOptions'
    """
