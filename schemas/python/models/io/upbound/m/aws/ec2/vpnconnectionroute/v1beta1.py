...
#   filename:  workdir/ec2_aws_m_upbound_io_v1beta1_vpnconnectionroute.yaml
...
class ForProvider(BaseModel):
    ...
    """
    vpnConnectionId: str | None = None
    """
    The ID of the VPN connection.
    """
    vpnConnectionIdRef: VpnConnectionIdRef | None = None
    """
    Reference to a VPNConnection in ec2 to populate vpnConnectionId.
    """
    vpnConnectionIdSelector: VpnConnectionIdSelector | None = None
    """
...
class VPNConnectionRoute(BaseModel):
    ...
    """
    kind: Literal['VPNConnectionRoute'] | None = 'VPNConnectionRoute'
    """
