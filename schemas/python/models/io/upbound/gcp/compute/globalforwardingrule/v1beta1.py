...
#   filename:  workdir/compute_gcp_upbound_io_v1beta1_globalforwardingrule.yaml
...
class ForProvider(BaseModel):
    ...
    """
    serviceDirectoryRegistrations: Optional[List[ServiceDirectoryRegistration]] = None
    """
