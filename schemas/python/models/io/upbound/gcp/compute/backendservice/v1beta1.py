...
class LocalityLbPolicy(BaseModel):
    customPolicy: list[CustomPolicyItem] | None = None
    """
    The configuration for a custom policy implemented by the user and
    deployed with the client.
    Structure is documented below.
    """
    policy: list[PolicyItem] | None = None
    """
...
class SecuritySetting(BaseModel):
    awsV4Authentication: list[AwsV4AuthenticationItem] | None = None
    """
...
class ForProvider(BaseModel):
    ...
    """
    securitySettings: list[SecuritySetting] | None = None
    """
    ...
    """
    tlsSettings: list[TlsSetting] | None = None
    """
