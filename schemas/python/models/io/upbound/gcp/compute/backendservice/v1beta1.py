...
#   filename:  workdir/compute_gcp_upbound_io_v1beta1_backendservice.yaml
...
class LocalityLbPolicy(BaseModel):
    customPolicy: Optional[List[CustomPolicyItem]] = None
    """
    The configuration for a custom policy implemented by the user and
    deployed with the client.
    Structure is documented below.
    """
    policy: Optional[List[PolicyItem]] = None
    """
...
class AwsV4AuthenticationItem(BaseModel):
...
class SecuritySetting(BaseModel):
    awsV4Authentication: Optional[List[AwsV4AuthenticationItem]] = None
    """
...
class ForProvider(BaseModel):
    ...
    """
    securitySettings: Optional[List[SecuritySetting]] = None
    """
    ...
    """
    tlsSettings: Optional[List[TlsSetting]] = None
    """
...
class AwsV4AuthenticationItemModel(BaseModel):
    accessKeyId: Optional[str] = None
    """
    The identifier of an access key used for s3 bucket authentication.
    """
