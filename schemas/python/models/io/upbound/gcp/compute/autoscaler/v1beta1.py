...
class ScaleInControlItem(BaseModel):
    maxScaledInReplicas: list[MaxScaledInReplica] | None = None
    """
...
class AutoscalingPolicyItem(BaseModel):
    ...
    """
    cpuUtilization: list[CpuUtilizationItem] | None = None
    """
    ...
    Structure is documented below.
    """
    loadBalancingUtilization: list[LoadBalancingUtilizationItem] | None = None
    """
    ...
    """
    scaleInControl: list[ScaleInControlItem] | None = None
    """
...
class Autoscaler(BaseModel):
    ...
    """
    kind: Literal['Autoscaler'] | None = 'Autoscaler'
    """
