...
#   filename:  workdir/network_azure_upbound_io_v1beta1_connectionmonitor.yaml
...
class HttpConfigurationItem(BaseModel):
...
class IcmpConfigurationItem(BaseModel):
...
class SuccessThresholdItem(BaseModel):
...
class TcpConfigurationItem(BaseModel):
...
class TestConfigurationItem(BaseModel):
    httpConfiguration: list[HttpConfigurationItem] | None = None
    """
    A http_configuration block as defined below.
    """
    icmpConfiguration: list[IcmpConfigurationItem] | None = None
    """
    ...
    """
    successThreshold: list[SuccessThresholdItem] | None = None
    """
    A success_threshold block as defined below.
    """
    tcpConfiguration: list[TcpConfigurationItem] | None = None
    """
