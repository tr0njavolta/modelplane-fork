...
#   filename:  workdir/network_azure_upbound_io_v1beta1_virtualnetwork.yaml
...
class DdosProtectionPlanItem(BaseModel):
...
class ForProvider(BaseModel):
    ...
    """
    ddosProtectionPlan: list[DdosProtectionPlanItem] | None = None
    """
    ...
    """
    encryption: list[EncryptionItem] | None = None
    """
...
class ServiceDelegationItem(BaseModel):
...
class DelegationItem(BaseModel):
    ...
    The name of the subnet.
    """
    serviceDelegation: list[ServiceDelegationItem] | None = None
    """
