...
#   filename:  workdir/network_azure_upbound_io_v1beta1_vpngateway.yaml
...
class Instance0BgpPeeringAddres(BaseModel):
...
class Instance1BgpPeeringAddres(BaseModel):
    customIps: list[str] | None = None
    """
    A list of custom BGP peering addresses to assign to this instance.
    """
...
class BgpSetting(BaseModel):
    ...
    """
    instance0BgpPeeringAddress: list[Instance0BgpPeeringAddres] | None = None
    """
    An instance_bgp_peering_address block as defined below.
    """
    instance1BgpPeeringAddress: list[Instance1BgpPeeringAddres] | None = None
    """
    An instance_bgp_peering_address block as defined below.
    """
...
class Instance0BgpPeeringAddresModel(BaseModel):
    customIps: list[str] | None = None
    """
    A list of custom BGP peering addresses to assign to this instance.
    """
...
class Instance1BgpPeeringAddresModel(BaseModel):
    customIps: list[str] | None = None
    """
    A list of custom BGP peering addresses to assign to this instance.
    """
...
class BgpSettingModel(BaseModel):
    asn: float | None = None
    """
    The ASN of the BGP Speaker. Changing this forces a new resource to be created.
    """
    ...
    """
    instance0BgpPeeringAddress: list[Instance0BgpPeeringAddresModel] | None = None
    """
    An instance_bgp_peering_address block as defined below.
    """
    instance1BgpPeeringAddress: list[Instance1BgpPeeringAddresModel] | None = None
    """
    An instance_bgp_peering_address block as defined below.
    """
    peerWeight: float | None = None
...
class AtProvider(BaseModel):
    ...
    Is BGP route translation for NAT on this VPN Gateway enabled? Defaults to false.
    """
    bgpSettings: list[BgpSettingModel] | None = None
    """
    A bgp_settings block as defined below.
    """
    id: str | None = None
