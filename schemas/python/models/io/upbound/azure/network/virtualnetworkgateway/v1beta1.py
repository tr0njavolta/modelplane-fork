...
#   filename:  workdir/network_azure_upbound_io_v1beta1_virtualnetworkgateway.yaml
...
class CustomRouteItem(BaseModel):
...
class VpnClientConfigurationItem(BaseModel):
...
class ForProvider(BaseModel):
    ...
    """
    vpnClientConfiguration: list[VpnClientConfigurationItem] | None = None
    """
