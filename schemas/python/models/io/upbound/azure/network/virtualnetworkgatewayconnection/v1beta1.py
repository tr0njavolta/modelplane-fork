...
#   filename:  workdir/network_azure_upbound_io_v1beta1_virtualnetworkgatewayconnection.yaml
...
class CustomBgpAddress(BaseModel):
...
class ForProvider(BaseModel):
    ...
    """
    customBgpAddresses: list[CustomBgpAddress] | None = None
    """
