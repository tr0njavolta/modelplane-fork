...
#   filename:  workdir/network_azure_upbound_io_v1beta1_firewallpolicy.yaml
...
class ExplicitProxyItem(BaseModel):
    enablePacFile: bool | None = None
    """
...
class LogAnalyticsWorkspaceItem(BaseModel):
    firewallLocation: str | None = None
    """
...
class Insight(BaseModel):
    defaultLogAnalyticsWorkspaceId: str | None = None
    """
    ...
    """
    logAnalyticsWorkspace: list[LogAnalyticsWorkspaceItem] | None = None
    """
    A list of log_analytics_workspace block as defined below.
    """
    retentionInDays: float | None = None
    """
...
class IntrusionDetectionItem(BaseModel):
    mode: str | None = None
    """
    In which mode you want to run intrusion detection: Off, Alert or Deny.
    """
    privateRanges: list[str] | None = None
    """
    ...
    """
    signatureOverrides: list[SignatureOverride] | None = None
    """
    One or more signature_overrides blocks as defined below.
    """
    trafficBypass: list[TrafficBypas] | None = None
    """
...
class ThreatIntelligenceAllowlistItem(BaseModel):
...
class TlsCertificateItem(BaseModel):
...
class ForProvider(BaseModel):
    autoLearnPrivateRangesEnabled: bool | None = None
    """
    Whether enable auto learn private ip range.
    """
    basePolicyId: str | None = None
    """
    The ID of the base Firewall Policy.
    """
    dns: list[Dn] | None = None
    """
    A dns block as defined below.
    """
    explicitProxy: list[ExplicitProxyItem] | None = None
    """
    ...
    """
    intrusionDetection: list[IntrusionDetectionItem] | None = None
    """
    ...
    """
    sqlRedirectAllowed: bool | None = None
    """
    ...
    """
    threatIntelligenceAllowlist: list[ThreatIntelligenceAllowlistItem] | None = None
    """
    A threat_intelligence_allowlist block as defined below.
    """
    threatIntelligenceMode: str | None = None
    """
    The operation mode for Threat Intelligence. Possible values are Alert, Deny and Off. Defaults to Alert.
    """
    tlsCertificate: list[TlsCertificateItem] | None = None
    """
...
class AtProvider(BaseModel):
    ...
    The ID of the base Firewall Policy.
    """
    childPolicies: list[str] | None = None
    """
    ...
    The name of the Resource Group where the Firewall Policy should exist. Changing this forces a new Firewall Policy to be created.
    """
    ruleCollectionGroups: list[str] | None = None
    """
