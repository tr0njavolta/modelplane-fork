...
#   filename:  workdir/network_azure_upbound_io_v1beta1_vpnsite.yaml
...
class TrafficCategoryItem(BaseModel):
...
class O365PolicyItem(BaseModel):
    trafficCategory: list[TrafficCategoryItem] | None = None
    """
...
class ForProvider(BaseModel):
    ...
    """
    o365Policy: list[O365PolicyItem] | None = None
    """
