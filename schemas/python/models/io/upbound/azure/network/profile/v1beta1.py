...
#   filename:  workdir/network_azure_upbound_io_v1beta1_profile.yaml
...
class ContainerNetworkInterfaceItem(BaseModel):
...
class ForProvider(BaseModel):
    containerNetworkInterface: list[ContainerNetworkInterfaceItem] | None = None
    """
...
class AtProvider(BaseModel):
    ...
    A container_network_interface block as documented below.
    """
    containerNetworkInterfaceIds: list[str] | None = None
    """
...
class Profile(BaseModel):
    ...
    """
    kind: Literal['Profile'] | None = 'Profile'
    """
