...
#   filename:  workdir/containerservice_azure_upbound_io_v1beta2_kubernetescluster.yaml
...
class KubernetesCluster(BaseModel):
    apiVersion: Literal['containerservice.azure.upbound.io/v1beta2'] | None = (
        'containerservice.azure.upbound.io/v1beta2'
    )
    """
