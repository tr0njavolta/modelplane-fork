...
#   filename:  workdir/containerservice_azure_upbound_io_v1beta1_kubernetescluster.yaml
...
class AciConnectorLinuxItem(BaseModel):
...
class ApiServerAccessProfileItem(BaseModel):
...
class AutoScalerProfileItem(BaseModel):
...
class AzureActiveDirectoryRoleBasedAccessControlItem(BaseModel):
...
class BootstrapProfileItem(BaseModel):
...
class ConfidentialComputingItem(BaseModel):
...
class DefaultNodePoolItem(BaseModel):
...
class HttpProxyConfigItem(BaseModel):
...
class IngressApplicationGatewayItem(BaseModel):
...
class KeyManagementServiceItem(BaseModel):
...
class KeyVaultSecretsProviderItem(BaseModel):
...
class KubeletIdentityItem(BaseModel):
...
class LinuxProfileItem(BaseModel):
    adminUsername: str | None = None
    """
    The Admin Username for the Cluster. Changing this forces a new resource to be created.
    """
    sshKey: list[SshKeyItem] | None = None
    """
...
class MaintenanceWindowAutoUpgradeItem(BaseModel):
...
class MaintenanceWindowNodeO(BaseModel):
    dayOfMonth: float | None = None
    """
    The day of the month for the maintenance run. Required in combination with AbsoluteMonthly frequency. Value between 0 and 31 (inclusive).
    """
...
class MicrosoftDefenderItem(BaseModel):
...
class AdvancedNetworkingItem(BaseModel):
...
class LoadBalancerProfileItem(BaseModel):
...
class NatGatewayProfileItem(BaseModel):
    idleTimeoutInMinutes: float | None = None
    """
    Desired outbound flow idle timeout in minutes for the managed nat gateway. Must be between 4 and 120 inclusive. Defaults to 4.
    """
...
class NetworkProfileItem(BaseModel):
    advancedNetworking: list[AdvancedNetworkingItem] | None = None
    """
    ...
    """
    loadBalancerProfile: list[LoadBalancerProfileItem] | None = None
    """
    ...
    """
    natGatewayProfile: list[NatGatewayProfileItem] | None = None
    """
...
class ServiceMeshProfileItem(BaseModel):
...
class ServicePrincipalItem(BaseModel):
    clientId: str | None = None
    """
...
class UpgradeOverrideItem(BaseModel):
...
class WebAppRoutingItem(BaseModel):
...
class WorkloadAutoscalerProfileItem(BaseModel):
...
class ForProvider(BaseModel):
    aciConnectorLinux: list[AciConnectorLinuxItem] | None = None
    """
    ...
    """
    apiServerAccessProfile: list[ApiServerAccessProfileItem] | None = None
    """
    An api_server_access_profile block as defined below.
    """
    autoScalerProfile: list[AutoScalerProfileItem] | None = None
    """
    ...
    azureActiveDirectoryRoleBasedAccessControl: (
        list[AzureActiveDirectoryRoleBasedAccessControlItem] | None
    ) = None
    """
    ...
    """
    bootstrapProfile: list[BootstrapProfileItem] | None = None
    """
    A bootstrap_profile block as defined below.
    """
    confidentialComputing: list[ConfidentialComputingItem] | None = None
    """
    ...
    """
    defaultNodePool: list[DefaultNodePoolItem] | None = None
    """
    ...
    """
    httpProxyConfig: list[HttpProxyConfigItem] | None = None
    """
    ...
    """
    ingressApplicationGateway: list[IngressApplicationGatewayItem] | None = None
    """
    An ingress_application_gateway block as defined below.
    """
    keyManagementService: list[KeyManagementServiceItem] | None = None
    """
    ...
    """
    keyVaultSecretsProvider: list[KeyVaultSecretsProviderItem] | None = None
    """
    A key_vault_secrets_provider block as defined below.
    """
    kubeletIdentity: list[KubeletIdentityItem] | None = None
    """
    ...
    """
    linuxProfile: list[LinuxProfileItem] | None = None
    """
    ...
    """
    maintenanceWindowAutoUpgrade: list[MaintenanceWindowAutoUpgradeItem] | None = None
    """
    A maintenance_window_auto_upgrade block as defined below.
    """
    maintenanceWindowNodeOs: list[MaintenanceWindowNodeO] | None = None
    """
    A maintenance_window_node_os block as defined below.
    """
    microsoftDefender: list[MicrosoftDefenderItem] | None = None
    """
    A microsoft_defender block as defined below.
    """
    monitorMetrics: list[MonitorMetric] | None = None
    """
    Specifies a Prometheus add-on profile for the Kubernetes Cluster. A monitor_metrics block as defined below.
    """
    networkProfile: list[NetworkProfileItem] | None = None
    """
    ...
    """
    omsAgent: list[OmsAgentItem] | None = None
    """
    ...
    """
    serviceMeshProfile: list[ServiceMeshProfileItem] | None = None
    """
    A service_mesh_profile block as defined below.
    """
    servicePrincipal: list[ServicePrincipalItem] | None = None
    """
    ...
    """
    storageProfile: list[StorageProfileItem] | None = None
    """
    ...
    """
    upgradeOverride: list[UpgradeOverrideItem] | None = None
    """
    A upgrade_override block as defined below.
    """
    webAppRouting: list[WebAppRoutingItem] | None = None
    """
    ...
    """
    workloadAutoscalerProfile: list[WorkloadAutoscalerProfileItem] | None = None
    """
...
class ServicePrincipalItemModel(BaseModel):
    clientId: str | None = None
    """
    The Client ID for the Service Principal.
    """
...
class WindowsProfileItemModel(BaseModel):
...
class InitProvider(BaseModel):
    ...
    A service_mesh_profile block as defined below.
    """
    servicePrincipal: list[ServicePrincipalItemModel] | None = None
    """
    A service_principal block as documented below. One of either identity or service_principal must be specified.
    """
    skuTier: str | None = None
    ...
    A web_app_routing block as defined below.
    """
    windowsProfile: list[WindowsProfileItemModel] | None = None
    """
    A windows_profile block as defined below.
    """
    workloadAutoscalerProfile: list[WorkloadAutoscalerProfileItem] | None = None
...
class AciConnectorLinuxItemModel(BaseModel):
...
class ApiServerAccessProfileItemModel(BaseModel):
    authorizedIpRanges: list[str] | None = None
    """
    Set of authorized IP ranges to allow access to API server, e.g. ["198.51.100.0/24"].
    """
...
class DefaultNodePoolItemModel(BaseModel):
    autoScalingEnabled: bool | None = None
    """
    Should the Kubernetes Auto Scaler be enabled for this Node Pool?
    """
...
class HttpProxyConfigItemModel(BaseModel):
    httpProxy: str | None = None
    """
    The proxy address to be used when communicating over HTTP.
    """
...
class IngressApplicationGatewayItemModel(BaseModel):
...
class KeyVaultSecretsProviderItemModel(BaseModel):
...
class LoadBalancerProfileItemModel(BaseModel):
    backendPoolType: str | None = None
    """
    The type of the managed inbound Load Balancer Backend Pool. Possible values are NodeIP and NodeIPConfiguration. Defaults to NodeIPConfiguration. See the documentation for more information.
    """
...
class NatGatewayProfileItemModel(BaseModel):
    effectiveOutboundIps: list[str] | None = None
    """
    The outcome (resource IDs) of the specified arguments.
    """
...
class OmsAgentItemModel(BaseModel):
    logAnalyticsWorkspaceId: str | None = None
    """
    The ID of the Log Analytics Workspace which the OMS Agent should send data to.
    """
...
class ServicePrincipalItemModel1(BaseModel):
    clientId: str | None = None
    """
    The Client ID for the Service Principal.
    """
...
class WebAppRoutingItemModel(BaseModel):
    defaultNginxController: str | None = None
    """
    Specifies the ingress type for the default NginxIngressController custom resource. The allowed values are None, Internal, External and AnnotationControlled. Defaults to AnnotationControlled.
    """
...
class WindowsProfileItemModel1(BaseModel):
    adminUsername: str | None = None
    """
    The Admin Username for Windows VMs. Changing this forces a new resource to be created.
    """
...
class AtProvider(BaseModel):
    aciConnectorLinux: list[AciConnectorLinuxItemModel] | None = None
    """
    A aci_connector_linux block as defined below. For more details, please visit Create and configure an AKS cluster to use virtual nodes.
    """
    aiToolchainOperatorEnabled: bool | None = None
    ...
    Specifies whether the AI Toolchain Operator should be enabled for the Cluster. Defaults to false.
    """
    apiServerAccessProfile: list[ApiServerAccessProfileItemModel] | None = None
    """
    An api_server_access_profile block as defined below.
    """
    autoScalerProfile: list[AutoScalerProfileItem] | None = None
    ...
    A list of up to 10 base64 encoded CA certificates that will be added to the trust store on nodes.
    """
    defaultNodePool: list[DefaultNodePoolItemModel] | None = None
    """
    Specifies configuration for "System" mode node pool. A default_node_pool block as defined below.
    """
    diskEncryptionSetId: str | None = None
    ...
    """
    httpProxyConfig: list[HttpProxyConfigItemModel] | None = None
    """
    A http_proxy_config block as defined below.
    """
    id: str | None = None
    ...
    Specifies the interval in hours when images should be cleaned up.
    """
    ingressApplicationGateway: list[IngressApplicationGatewayItemModel] | None = None
    """
    An ingress_application_gateway block as defined below.
    """
    keyManagementService: list[KeyManagementServiceItem] | None = None
    ...
    A key_management_service block as defined below. For more details, please visit Key Management Service (KMS) etcd encryption to an AKS cluster.
    """
    keyVaultSecretsProvider: list[KeyVaultSecretsProviderItemModel] | None = None
    """
    A key_vault_secrets_provider block as defined below.
    """
    kubeletIdentity: list[KubeletIdentityItem] | None = None
    ...
    """
    omsAgent: list[OmsAgentItemModel] | None = None
    """
    An oms_agent block as defined below.
    """
    openServiceMeshEnabled: bool | None = None
    ...
    A service_mesh_profile block as defined below.
    """
    servicePrincipal: list[ServicePrincipalItemModel1] | None = None
    """
    A service_principal block as documented below. One of either identity or service_principal must be specified.
    """
    skuTier: str | None = None
    ...
    A upgrade_override block as defined below.
    """
    webAppRouting: list[WebAppRoutingItemModel] | None = None
    """
    A web_app_routing block as defined below.
    """
    windowsProfile: list[WindowsProfileItemModel1] | None = None
    """
    A windows_profile block as defined below.
    """
    workloadAutoscalerProfile: list[WorkloadAutoscalerProfileItem] | None = None
