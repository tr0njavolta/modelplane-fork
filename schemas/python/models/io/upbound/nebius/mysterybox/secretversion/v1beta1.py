...
#   filename:  workdir/mysterybox_nebius_upbound_io_v1beta1_secretversion.yaml
...
class SecretVersion(BaseModel):
    apiVersion: Literal['mysterybox.nebius.upbound.io/v1beta1'] | None = (
        'mysterybox.nebius.upbound.io/v1beta1'
    )
    """
