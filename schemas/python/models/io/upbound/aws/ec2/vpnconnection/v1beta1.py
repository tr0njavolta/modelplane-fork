...
class Tunnel1LogOption(BaseModel):
    cloudwatchLogOptions: list[CloudwatchLogOption] | None = None
    """
...
class ForProvider(BaseModel):
    ...
    """
    tunnel1LogOptions: list[Tunnel1LogOption] | None = None
    """
    ...
    """
    tunnel2LogOptions: list[Tunnel2LogOption] | None = None
    """
    Options for logging VPN tunnel activity. See Log Options below for more details.
    """
