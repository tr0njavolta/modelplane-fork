...
class KubernetesNetworkConfigItem(BaseModel):
    elasticLoadBalancing: list[ElasticLoadBalancingItem] | None = None
    """
...
class OutpostConfigItem(BaseModel):
    ...
    """
    controlPlanePlacement: list[ControlPlanePlacementItem] | None = None
    """
...
class RemoteNetworkConfigItem(BaseModel):
    remoteNodeNetworks: list[RemoteNodeNetwork] | None = None
    """
    Configuration block with remote node network configuration for EKS Hybrid Nodes. Detailed below.
    """
    remotePodNetworks: list[RemotePodNetwork] | None = None
    """
...
class StorageConfigItem(BaseModel):
    blockStorage: list[BlockStorageItem] | None = None
    """
...
class ForProvider(BaseModel):
    ...
    """
    computeConfig: list[ComputeConfigItem] | None = None
    """
    Configuration block with compute configuration for EKS Auto Mode. Detailed below.
    """
    controlPlaneScalingConfig: list[ControlPlaneScalingConfigItem] | None = None
    """
    ...
    """
    encryptionConfig: list[EncryptionConfigItem] | None = None
    """
    ...
    """
    outpostConfig: list[OutpostConfigItem] | None = None
    """
    ...
    """
    remoteNetworkConfig: list[RemoteNetworkConfigItem] | None = None
    """
    ...
    """
    storageConfig: list[StorageConfigItem] | None = None
    """
    ...
    """
    upgradePolicy: list[UpgradePolicyItem] | None = None
    """
    ...
    """
    vpcConfig: list[VpcConfigItem] | None = None
    """
    ...
    """
    zonalShiftConfig: list[ZonalShiftConfigItem] | None = None
    """
...
class AtProvider(BaseModel):
    ...
    Desired Kubernetes master version. If you do not specify a value, the latest available version at resource creation is used and no upgrades will occur except those automatically triggered by EKS. The value must be configured and increased to upgrade the version when desired. Downgrades are not supported by EKS.
    """
    vpcConfig: list[VpcConfigItemModel] | None = None
    """
    Configuration block for the VPC associated with your cluster. Amazon EKS VPC resources have specific requirements to work properly with Kubernetes. For more information, see Cluster VPC Considerations and Cluster Security Group Considerations in the Amazon EKS User Guide. Detailed below. Also contains attributes detailed in the Attributes section.
    """
    zonalShiftConfig: list[ZonalShiftConfigItem] | None = None
